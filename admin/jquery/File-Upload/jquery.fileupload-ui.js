...
(function (factory) {
    ...
    $.widget('blueimpUI.fileupload', parentWidget, {
        ...
        options: {
            ...
            previewSourceFileTypes: mo_acceptImageTypes,       /*  /^image\/(gif|jpeg|png|vnd.microsoft.icon|ico|icon|x-icon|webp)$/, */
            ...
            // option of the $.ajax upload requests: json
            dataType: 'html',
