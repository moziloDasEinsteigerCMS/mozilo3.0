        ...
        _create: function() {
            ...
            for(i = 0; i < n.length; i++) {
                ...
                if(n[i] == "saturation" || n[i] == "brightness") {
                    ...
                    if(n[i] == "saturation")
                        this["s_"+n[i]].prepend('<img src="'+img_url+'black.png" style="position:absolute;width:100px" class="ui-corner-all ui-slider-horizontal" alt="" \/>');
                } else {
            ...
            $('.ce-default-color-box').width((194 + hsv_box_right) - (default_colors.outerWidth() - default_colors.width())).css("width","100%");
        ...
        _makeDefaultColors: function() {
            ...
            if(defaultcolors.length > 1) {
                ...
                for (var i = 0; i < defaultcolors_a.length; ++i) {
                    html += '<img title="'+defaultcolors_a[i]+'" class="ce-default-color-img ui-widget-content ui-corner-all" style="background-color:#'+defaultcolors_a[i]+';" src="'+ICON_URL_SLICE+'" alt=""\/>';
                }
