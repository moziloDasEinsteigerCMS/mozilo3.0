...
var delete_handler = function (event) {
    ...
    var dialog_text = "<span class=\"mo-align-center\">" + mozilo_lang["gallery_delete_confirm"] + "</span>" + "<span class=\"mo-bold\">" + this_li.find(".js-gallery-name").text() + "</span>" ;
...
$(function () {
    ...
    $(".new-gallery .js-file-dir").draggable({
    ...
    $(".js-gallery").droppable({
        ...
        distance: 30,
        cancel: ".js-file-dir",
        placeholder: "mo-placeholder mo-li mo-li-head-tag mo-li-head-tag-no-ul mo-tag-height-from-icon ui-corner-all ui-state-highlight green",
