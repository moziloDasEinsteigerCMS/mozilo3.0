...
$(function() {
    ...
    $('body').append('<div id="dialog-plugin-admin"><iframe style="overflow:visible; border: none; text-align:left; width:100%; height:100%;" \/><\/div>');
...
// und gespeicherten inhalt im iframe wieder herstellen
 ...
 //       var upper_tag = $(this).closest("div");
...
//    });
 ...
 /*   $("body").on("click",".js-toggle-manage", function(event) {
        var mo_ul = $(this).closest(".mo-ul");
        if(mo_ul.find(".js-toggle-manage-content").is(":visible")) {
     /*       mo_li.find(".mo-li-head-tag").removeClass("ui-corner-top").addClass("ui-corner-all");
   //         mo_ul.find(".js-toggle-manage-content").hide(anim_speed);
            $(".js-plugin-del:checked").prop("checked",false);
            $(".js-plugin-del").css("display","none");
            return;
        } else if(!mo_ul.find(".js-toggle-manage-content").is(":visible")) {
   /*         mo_li.find(".mo-li-head-tag").removeClass("ui-corner-all").addClass("ui-corner-top");
   //         mo_ul.find(".js-toggle-manage-content").show(anim_speed);
    ...
    $("body").on("click","#js-plugin-del-submit", function(event) {
        ...
        if($(".js-plugin-del:checked").length > 0) {
            $(".js-plugin-del:checked").each(function(){
                $("<span class=\"mo-bold\">"+$(this).val()+"<\/span>").appendTo(dialog_multi);
            });
            dialog_multi.dialog({
