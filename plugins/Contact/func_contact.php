...
$_SESSION['contactform_calculation'] = $_SESSION['contactform_calculation'] ?? '';
        ...
        if ($config_name[1] == "true") {
            ...
            if ($config_name[2] == "true") {
                $name_mandatory = "*";
                $name_mandatory_label = 'aria-required="true"'; 
            }
             else { 
					$name_mandatory = ""; 
      ...
      if ($config_mail[1] == "true") {
            ...
            if ($config_mail[2] == "true") {
                $mail_mandatory = "*";
                $mail_mandatory_label = 'aria-required="true"'; 
            } else { 
					$mail_mandatory = "";    
        ...
        if ($config_website[1] == "true") {
            ...
            if ($config_website[2] == "true") {
                $website_mandatory = "*";
                $website_mandatory_label = 'aria-required="true"'; 
            } else { 
					$website_mandatory = "";        
        ...
        //hp Ende
          if ($config_subject[1] == "true") {
            ...
            if ($config_subject[2] == "true") {
                $subject_mandatory = "*";
                $subject_mandatory_label = 'aria-required="true"'; 
            } else { 
					$subject_mandatory = "";  
        ...
        if ($config_message[1] == "true") {
            ...
            if ($config_message[2] == "true") {
                $message_mandatory = "*";
                $message_mandatory_label = 'aria-required="true"';
            } else { 
					$message_mandatory = "";   
