...
$css_replace['li.mainmenu'] = 'li.mainmenu-item';
$css_replace['li.detailmenu'] = 'li.detailmenu-item';
$css_replace['input.searchbutton'] = 'button.searchbutton';
$css_replace['.sitemap h2'] = '.result-list-header';
$css_replace['.sitemap li'] = '.result-list-item';
$css_replace['.sitemap'] = '#sitemap';
$css_replace['.searchmap'] = '.searchmap result-list';
    ...
    foreach(getDirAsArray(BASE_DIR.CONTENT_DIR_NAME,"dir","sort") as $cat) {
        ...
        foreach(getDirAsArray(BASE_DIR.CONTENT_DIR_NAME."/".$cat,"file","sort") as $page) {
            ...
            $newcontent = str_replace(array("[liste1|","[liste2|","[liste3|"),"[liste|",$newcontent);    
				$newcontent = str_replace("{CONTACT}","{Contact}",$newcontent);     
				$newcontent = str_replace("{LASTCHANGE}","{Lastchange}",$newcontent);        
